    ...
    /*    public IEnumerable<Customer> getCustomers()
        ...
        public bool CheckCustomerIdExits(Guid customerId)
        {
           ...
           *//* DynamicParameters dynamicParameters = new DynamicParameters();
            ...
            var customerIdExits = dbConnection.Query<Guid>("Proc_CheckCustomerIdExit",new { CustomerId = customerId.ToString()}, commandType:CommandType.StoredProcedure).FirstOrDefault();
